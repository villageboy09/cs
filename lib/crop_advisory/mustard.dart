...
class MustardDetailPage extends StatefulWidget {
  const MustardDetailPage({Key? key}) : super(key: key);

  @override
  _MustardDetailPageState createState() => _MustardDetailPageState();
}

class _MustardDetailPageState extends State<MustardDetailPage> {
    ...
    tileData = [
      {
        ...
        'description': AppLocalizations.of(context)?.mustard_soil_type_key ??
            'Default Description',
        'imageUrls': [
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.mustard_seed_rate_key ??
            'Default Description',
        'imageUrls': [
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.mustard_seed_treatment_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.mustard_growing_season_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.mustard_crop_duration_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        'title': AppLocalizations.of(context)?.irrigationSchedule ??
            'Irrigation Schedule',
        'description':
            AppLocalizations.of(context)?.mustard_irrigation_schedule_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.mustard_nutrient_requirement_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.mustard_weed_management_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)
                ?.mustard_disease_and_pest_management_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.mustard_harvesting_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.mustard_post_harvesting_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              AppLocalizations.of(context)?.mustard ?? 'Mustard',
