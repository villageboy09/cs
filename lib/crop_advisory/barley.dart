...
class _BarleyDetailPageState extends State<BarleyDetailPage> {
    ...
    tileData = [
      {
        ...
        'description': AppLocalizations.of(context)?.barley_soil_type_key ??
            'Default Description',
        'imageUrls': [
          'https://www.cropsync.online/logo.png',
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.barley_seed_rate_key ??
            'Default Description',
        'imageUrls': [
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.barley_seed_treatment_key ??
                'Default Description',
        'imageUrls': [
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.barley_growing_season_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.barley_crop_duration_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        'title': AppLocalizations.of(context)?.irrigationSchedule ??
            'Irrigation Schedule',
        'description':
            AppLocalizations.of(context)?.barley_irrigation_schedule_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.barley_nutrient_requirement_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.barley_weed_management_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)
                ?.barley_disease_and_pest_management_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
      ...
      },
      {
        ...
        'description': AppLocalizations.of(context)?.barley_harvesting_key ??
            'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
          'https://drive.google.com/uc?export=view&id=1emhFc_5q-UMlST8s5Mb9W91rZxrNr927',
      ...
      },
      {
        ...
        'description':
            AppLocalizations.of(context)?.barley_post_harvesting_key ??
                'Default Description',
        'imageUrls': [
          'https://drive.google.com/uc?export=view&id=19uzK7SJQ_LhL8gL032DdOGKaQhSzVWmV',
          'https://drive.google.com/uc?export=view&id=1PbGI9NTz_eVtHBqgxdNdppvZ7IjvPUhS'
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        Expanded(
          child: Text(
            AppLocalizations.of(context)?.barley ?? 'Barley',
    ...
    return AspectRatio(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, index) {
          return FittedBox(
            fit: BoxFit
                .cover, // You can change this to any BoxFit value (e.g., BoxFit.contain, BoxFit.fill)
